...
public class MainFragment extends Fragment {
    ...
    public void onCreate (Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null || !savedInstanceState.containsKey("LIST")) {
            ...
            mArtistItemList = savedInstanceState.getParcelableArrayList("LIST");
        }
    }
    ...
    /*
    * When the user clicks on an item the activity start a new intent.
    ...
    */
    private OnItemClickListener onArtistItemClickListener = new OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
            String spotifyId = mArtistListAdapter.getItem(position).getSpotifyId();
...
//            startActivity(intent);
    ...
    public void onSaveInstanceState(Bundle savedState) {
        savedState.putParcelableArrayList("LIST", mArtistItemList);
