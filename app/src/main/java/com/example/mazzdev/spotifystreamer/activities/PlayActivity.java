...
public class PlayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            args.putParcelableArrayList(PlayFragment.PLAY_TRACK_LIST_KEY,
                    getIntent().getParcelableArrayListExtra(PlayFragment.PLAY_TRACK_LIST_KEY));
            args.putInt(PlayFragment.PLAY_POSITION_KEY,
                    getIntent().getIntExtra(PlayFragment.PLAY_POSITION_KEY, 0));
